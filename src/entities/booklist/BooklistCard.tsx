...
export function BooklistCard({
  ...
  return (
    <article
      ...
      className="group flex cursor-pointer flex-col gap-4 border-b border-[color-mix(in_srgb,var(--od-text-secondary)_14%,transparent)] pb-5 transition-colors focus:outline-hidden focus-visible:ring-2 focus-visible:ring-(--od-accent) rounded-xl p-2"
      ...
      <div className="flex gap-4">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <div className="flex flex-wrap items-center gap-2 text-[11px]">
            ...
            <span className="text-(--od-text-tertiary)">更新于 {updatedText}</span>
          </div>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-[12px] text-(--od-text-secondary)">
            ...
            <span className="inline-flex items-center gap-1.5">
              ...
              <span className="text-(--od-accent)">{booklist.collection_count}</span>
              <span>收藏</span>
            </span>
            <span className="inline-flex items-center gap-1.5">
